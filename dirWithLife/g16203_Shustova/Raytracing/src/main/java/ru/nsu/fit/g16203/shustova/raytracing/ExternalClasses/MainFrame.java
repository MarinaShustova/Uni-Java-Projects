package ru.nsu.fit.g16203.shustova.raytracing.ExternalClasses;
...
//		toggleButtons.add(button);
	 ...
	 * @param menuPath - path to menu item to create toolbar button from
	 */
	public void addToolBarButton(String menuPath, boolean isToggle, boolean isSelected)
	{
		if (!isToggle) {
			toolBar.add(createToolBarButton(menuPath));
		}
		else {
			JToggleButton button = createToggleButton(menuPath);
